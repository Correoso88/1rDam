...
DECLARE
TYPE T_SALES IS TABLE OF NUMBER INDEX BY VARCHAR2(30);
VT_SALES T_SALES;
V_INDEX VARCHAR2(30);
BEGIN
SELECT COUNT(*) INTO VT_SALES('Blake') FROM ORDERS JOIN employees ON ORDERS.salesman_id = EMPLOYEES.employee_id WHERE ORDERS.STATUS = 'Shipped' and EMPLOYEES.first_name = 'Blake';
SELECT COUNT(*) INTO VT_SALES('Daisy') FROM ORDERS JOIN employees ON ORDERS.salesman_id = EMPLOYEES.employee_id WHERE ORDERS.STATUS = 'Shipped' and EMPLOYEES.first_name = 'Daisy';
SELECT COUNT(*) INTO VT_SALES('Lily') FROM ORDERS JOIN employees ON ORDERS.salesman_id = EMPLOYEES.employee_id WHERE ORDERS.STATUS = 'Shipped' and EMPLOYEES.first_name = 'Lily';
V_INDEX :='Blake';
DBMS_OUTPUT.PUT_LINE('INDEX: ' || V_INDEX || ', Vale: ' || VT_SALES(V_INDEX));
V_INDEX :='Daisy';
DBMS_OUTPUT.PUT_LINE('INDEX: ' || V_INDEX || ', Vale: ' || VT_SALES(V_INDEX));
V_INDEX :='Lily';
DBMS_OUTPUT.PUT_LINE('INDEX: ' || V_INDEX || ', Vale: ' || VT_SALES(V_INDEX));
