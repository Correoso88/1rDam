...
1. Guarda els 3 llibres amb més exemplars dins un VARRAY de records
de LLIBRE.
2. Imprimeix en pantalla (DBMS_OUTPUT.PUT_LINE) el títol dels 3
llibres i el seu autor, indicant l’ordre.*/
