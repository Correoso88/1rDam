...
Google Classroom
Classroom
2526_Bases de Dades_1rDAM
Inici
Calendari
Cursos on us heu inscrit
Pendents
D
...
FCT 24-25 dimarts
A
Aplicacions Web 24-25
2n SMX
2
24-25 SEGURETAT 2n SMX
🔌
🔌 Serveis en Xarxa 24-25
T
TUTORIA 24-25 2n SMX
2n SMX
Classes arxivades
Configuració
Tauler d'activitat
Treball de classe
Persones
Esquema HR per PLSQL s'ha desplegatTreball de classe de 2526_Bases de Dades_1rDAM - Classroom
--------------------------------------------------------------------------------------
...
2. Declara un procediment que “retorni” el correu electronic i el telèfon
d’un empleat, donat el seu FIRST_NAME i LAST_NAME. Utilitza
paràmetres OUT.

3. Utilitza els dos subprogrames anteriors a un bloc anònim per obtenirG
el job_title, el correu i el telèfon de l’empleat “Blake Cooper”.
*/

DECLARE
    V_EMAIL VARCHAR2(255);
    V_PHONE VARCHAR2(50);
    FUNCTION DEVOLVER_TRABAJO(V_FIRST_NAME VARCHAR2, V_LAST_NAME VARCHAR2) RETURN EMPLOYEES.JOB_TITLE%TYPE IS
    ...
    PROCEDURE DEVOLVER_CORREO_TELEFONO(V_FIRST_NAME IN VARCHAR2, V_LAST_NAME IN VARCHAR2, V_EMAIL OUT VARCHAR2, V_PHONE OUT VARCHAR2) IS 
    BEGIN
        SELECT PHONE, EMAIL INTO V_PHONE, V_EMAIL FROM EMPLOYEES WHERE FIRST_NAME = V_FIRST_NAME AND LAST_NAME = V_LAST_NAME;

    END;
BEGIN
    DBMS_OUTPUT.PUT_LINE(DEVOLVER_TRABAJO('Blake','Cooper'));
    DEVOLVER_CORREO_TELEFONO('Blake','Cooper', V_EMAIL, V_PHONE);
    DBMS_OUTPUT.PUT_LINE('Email: ' || V_EMAIL);
    DBMS_OUTPUT.PUT_LINE('Telefono: ' || V_PHONE);
END;