...
DECLARE
vCountryName VARCHAR2(10):='SPAIN';
vCountryID varchar2(2):='SP';
vregion_id number;
BEGIN
SELECT region_id into vregion_id from regions where regions.region_name = 'Europe';
INSERT INTO COUNTRIES VALUES(vcOUNTYID.VCOUNTRYNAME,VREGION_ID);
END;